    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/Harshithaa-R/Smart-AI-Resume-Analyzer' target='_blank' style='text-decoration: none;'>
            ...
            <p style='text-align: center;'>
                ...
                <a href="https://www.linkedin.com/in/harshithaa-r-959209334/" target="_blank" style='text-decoration: none; color: #FFFFFF'>
                    <b>Harshithaa R</b>
                </a>
            </p>
                ...
                try:
                    ...
                    if resume_buffer:
                        try:
                            ...
                            file_name = current_name.replace(' ', '_') + "_resume.docx"
                            st.download_button(
